...
分析视图解释了更改的内容及其原因。可以使用引导式补救措施（例如 *Fix It*）来帮助恢复合规性。某些补救措施可以就地应用，而其他补救措施可能需要将工作负载调整到不同的存储类以恢复预期的行为。
...
link:concept-manage-storage.html["了解 NetApp Console 本地部署中的机群管理"].
...
* link:concept-manage-storage.html["了解 NetApp Console 本地部署中的机群管理"].
* link:task-storage-class-manage.html["管理存储类和策略"].
...
* link:reference-console-assistant-operations.html["查看受支持的 Console 助手操作"]
* link:task-storage-class-drift-remediate.html["了解如何修复存储类漂移"]
