...
* *ONTAP 警报*源自 NetApp Console 本地部署发现的本地集群上的 ONTAP 事件管理系统 (EMS)。 link:https://docs.netapp.com/us-en/ontap-ems/acp-auto-events.html["详细了解 ONTAP EMS 和可用警报。"^]
...
* link:task-alert-rules-manage.html["创建和管理警报通知规则"]
