...
link:concept-folders-fleets-overview.html["详细了解 NetApp Console 本地部署中的文件夹和机群"].
...
* link:concept-storage-classes.html["了解 NetApp Console 本地部署中的存储类和策略"].
* link:task-iam-manage-folders-fleets.html["了解如何创建和管理队列"].
